...
values."
  (setq-default
   ...
   '(
     ...
     org
     (shell :variables
             shell-default-shelll 'ansi-term
   ...
   ;; List of additional ckages that will be installed without being
...
values."
  ...
  (setq-default
   ...
   ;; Majo4mode leader key accessible in `emacs state' and `insert state'.
   ;; (default "C-M-m")
